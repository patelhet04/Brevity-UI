...
>(({ className, children, position = "popper", ...props }, ref) => {
  ...
  return (
    <SelectPrimitive.Portal container={mounted ? document.body : undefined}>
      <SelectPrimitive.Content
        ref={ref}
        className={cn(
          "fixed z-50 max-h-96 min-w-[8rem] overflow-hidden rounded-xl border bg-popover text-popover-foreground shadow-md will-change-[opacity,transform]",
          className
        )}
        position={position}
        sideOffset={4}
